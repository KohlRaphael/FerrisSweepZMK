...
#define MIRYOKU_LAYER_BASE \
&kp P,             U_TD(U, DE_UE),    &kp DE_MINS,        &kp DE_COMM,        &kp Q,              &kp G,             &kp C,             &kp L,              &kp M,            &kp F,              \
U_MT(LGUI, H),     U_MT(LALT, I),     U_MT(LCTRL, E),     U_MT(LSHFT, A),     U_TD(O, DE_OE),     &kp D,             U_MT(LSHFT, T),    U_MT(LCTRL, R),     U_MT(LALT, N),    U_MT(LGUI, S),      \
U_LT(U_BUTTON, K), U_MT(RALT, Y),     &kp DE_DOT,         &kp DE_QUOT,        &kp X,              &kp J,             &kp V,             &kp W,              U_MT(RALT, B),    U_LT(U_BUTTON, Z),  \
